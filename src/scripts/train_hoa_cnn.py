...
def _prediction_eval_for_split(
    *,
    ...
    model_raw_mae = model_raw_mae_total / total_values
    identity_raw_mae = identity_raw_mae_total / total_values
    relative_gain = 1.0 - (model_raw_mae / identity_raw_mae)
...
def main() -> None:
    ...
    model.compile(
        optimizer=optimizer,
        loss=keras.losses.Huber(delta=float(training_section.get("huber_delta", 1.0))),
